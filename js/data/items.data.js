...
const rawList = [
    ...
    },
    {
        ...
        content:
            ...
            'En allumant la vôtre, vous la taquinez en répondant que vous, au moins, vous avez du feu, même s\'il est bientôt à sec, et vous éclatez ensemble d\'un rire sincère.',
        buttons: [
            {
                if: null,
                text:
